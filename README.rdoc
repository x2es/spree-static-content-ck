...
Goal of this fork: cut WYSIWYG-editor in favor to using CKEditor extension (http://github.com/davidnorth/spree-ckeditor) which replaces any TextArea in admin pages by CKEditor.

= Usage

Suggesting usage together with the spree-ckeditor extension (http://github.com/davidnorth/spree-ckeditor), which replaces all admin's TextAreas by CKEditor.
